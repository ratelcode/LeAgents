...
from leloop.orchestrator.proposer import Proposer
...
if TYPE_CHECKING:  # runtime import would be circular: agents depend on orchestrator
    ...
    from leloop.agents.eval_agent import EvalAgent
    from leloop.agents.improve_agent import ImproveAgent
    from leloop.agents.knowledge_agent import KnowledgeAgent
    from leloop.agents.train_agent import TrainAgent
